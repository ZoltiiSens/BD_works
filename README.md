...
Для виконання лабораторних робіт необхідно зробити ```fork``` цього репозіторію, склонувати вже власний репозиторій та розміщувати документацію у відповідних директоріях ```./docs```.

В цьому файлі необхідно вказати тему лабораторних робіт (назву проєкту). Коротку загальну характеристику
проєкту, контактні дані виконавця, посилання на репо співвиконавців (за необхідністю).
