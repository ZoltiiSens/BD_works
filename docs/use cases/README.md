...
:Відправляє сповіщення про успішне створення опитування;
...
|Інтерв'юер|
: Інтерв'юер вносить зміни до опитування;

|Система|
:Система оброблює введені дані;
:Система зберігає зміни в опитуванні у базі даних;
...
|Інтерв'юер|
start;
:Натискає на кнопку "Деталі опитування";
...
|Система|
:Система оброблює запит;
:Система видаляє користувача з бази даних;
:Відправляє сповіщення про успішне видалення користувача;
